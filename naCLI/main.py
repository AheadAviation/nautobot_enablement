...
class NerdCliScenarios(Enum):
    """NerdCLI scenarios."""

    BASIC_NAUTOBOT = "basic-nautobot"
...
def containerlab_deploy(
    topology: Path = typer.Argument(Path("./containerlab/base-topology.yml"), help="Path to the topology file", exists=True),
    sudo: bool = typer.Option(True, help="Use sudo to run containerlab", envvar="LAB_SUDO"),
):
    """Deploy a containerlab topology.

    [u]Example:[/u]
        [i]nerd-ahead-cli containerlab deploy --topology ./containerlab/base-topology.yml[/i]
    """
...
def containerlab_destroy(
    ...
    [u]Example:[/u]
        [i]nerd-ahead-cli containerlab destroy --topology ./containerlab/base-topology.yml[/i]
    """
    console.log("Deploying containerlab topology", style="info")
    console.log(f"Topology file: [orange1 i]{topology}", style="info")
...
def containerlab_inspect(
    ...
    [u]Example:[/u]
        [i]nerd-ahead-cli containerlab show --topology ./containerlab/base-topology.yml[/i]
    """
...
def docker_build(
    scenario: Annotated[
        NerdCliScenarios, typer.Option("--scenario", "-s", help="Scenario to execute command", envvar="LAB_SCENARIO")
    ],
    ...
    To build all services:
        [i]nerd-ahead-cli docker build --scenario basic-nautobot[/i]

    To build a specific services:
        [i]nerd-ahead-cli docker build telegraf-01 telegraf-02 --scenario basic-nautobot[/i]
    """
    console.log(f"Building service(s): [orange1 i]{services}", style="info")
    run_docker_compose_cmd(
        action="build",
        filename=Path(f"./scenarios/{scenario.value}/docker-compose.yml"),
...
def docker_exec(
    ...
    To execute a command in a service:
        [i]nerd-ahead-cli docker exec telegraf-01 --scenario basic-nautobot --command bash[/i]

        To execute a command in a service and verbose mode:
        [i]nerd-ahead-cli docker exec telegraf-01 --scenario basic-nautobot --command bash --verbose[/i]
    """
...
def docker_debug(
    ...
    To start all services in debug mode:
        [i]nerd-ahead-cli docker debug --scenario basic-nautobot[/i]

    To start a specific service in debug mode:
        [i]nerd-ahead-cli docker debug telegraf-01 --scenario basic-nautobot[/i]
    """
...
def docker_start(
    ...
    To start all services:
        [i]nerd-ahead-cli docker start --scenario basic-nautobot[/i]

    To start a specific service:
        [i]nerd-ahead-cli docker start telegraf-01 --scenario basic-nautobot[/i]
    """
...
def docker_stop(
    ...
    To stop all services:
        [i]nerd-ahead-cli docker stop --scenario basic-nautobot[/i]

    To stop a specific service:
        [i]nerd-ahead-cli docker stop telegraf-01 telegraf-02 --scenario basic-nautobot[/i]
    """
...
def docker_restart(
    ...
    To restart all services:
        [i]nerd-ahead-cli docker restart --scenario basic-nautobot[/i]

    To restart a specific service:
        [i]nerd-ahead-cli docker restart telegraf-01 logstash --scenario basic-nautobot[/i]
    """
...
def docker_logs(
    ...
    To show logs for all services:
        [i]nerd-ahead-cli docker logs --scenario basic-nautobot[/i]

    To show logs for a specific service:
        [i]nerd-ahead-cli docker logs telegraf-01 --scenario basic-nautobot[/i]

    To show logs for a specific service and follow the logs and tail 10 lines:
        [i]nerd-ahead-cli docker logs telegraf-01 --scenario basic-nautobot --follow --tail 10[/i]
    """
...
def docker_ps(
    ...
    To show all services:
        [i]nerd-ahead-cli docker ps --scenario basic-nautobot[/i]

    To show a specific service:
        [i]nerd-ahead-cli docker ps telegraf-01 --scenario basic-nautobot[/i]
    """
...
def docker_destroy(
    ...
    To destroy all services:
        [i]nerd-ahead-cli docker destroy --scenario basic-nautobot[/i]

    To destroy a specific service:
        [i]nerd-ahead-cli docker destroy --scenario basic-nautobot[/i]

    To destroy a specific service and remove volumes:
        [i]nerd-ahead-cli docker destroy telegraf-01 --volumes --scenario basic-nautobot[/i]

    To destroy all services and remove volumes:
        [i]nerd-ahead-cli docker destroy --volumes --scenario basic-nautobot[/i]
    """
...
def docker_rm(
    ...
    To remove all services:
        [i]nerd-ahead-cli docker rm --scenario basic-nautobot[/i]

    To remove a specific service:
        [i]nerd-ahead-cli docker rm telegraf-01 --scenario basic-nautobot[/i]

    To remove a specific service and remove volumes:
        [i]nerd-ahead-cli docker rm telegraf-01 --volumes --scenario basic-nautobot[/i]

    To remove all services and remove volumes:
        [i]nerd-ahead-cli docker rm --volumes --scenario basic-nautobot[/i]

    To remove all services and force removal of containers:
        [i]nerd-ahead-cli docker rm --force --scenario basic-nautobot[/i]

    To force removal of a specific service and remove volumes:
        [i]nerd-ahead-cli docker rm telegraf-01 --volumes --force --scenario basic-nautobot[/i]
    """
    extra_options = "--stop "
    if force:
        extra_options += "--force "
...
def lab_deploy(
    ...
    topology: Annotated[Path, typer.Option(help="Path to the topology file", exists=True)] = Path(
        "./containerlab/base-topology.yml"
    ),
...
def lab_purge(
    ...
    for scenario in NerdCliScenarios:
        try:
...
def lab_update(
    ...
    To update all services:
        [i]nerd-ahead-cli lab update --scenario basic-nautobot[/i]

    To update a specific service:
        [i]nerd-ahead-cli lab update telegraf-01 telegraf-02 --scenario basic-nautobot[/i]
    """
...
def lab_rebuild(
    ...
    To rebuild all services:
        [i]nerd-ahead-cli lab rebuild --scenario basic-nautobot[/i]

    To rebuild a specific service:
        [i]nerd-ahead-cli lab rebuild webhook --scenario basic-nautobot[/i]
    """
